...
if openai.api_key is None:
	openai.api_key = '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'
...
------------------
OBJECTIVE: Find out if enzo@june.so is a founder
CURRENT URL: https://www.google.com/search?q=enzo%40june.so
YOUR COMMAND: 
ANSWER "He is a founder"
==================================================
EXAMPLE 2:
==================================================
CURRENT BROWSER CONTENT:
...
<text id=18>Settings</text>
------------------
OBJECTIVE: Find someone called Amine working at waldo.com
CURRENT URL: https://www.google.com/
YOUR COMMAND: 
TYPESUBMIT 5 "Amine waldo.com linkedin"
==================================================
...
#instead of name == main, change this to a function that is called from main.py
def runFile(objective):
    #print obejctive to console
	...
	def run_cmd(cmd):
		...
		if cmd.startswith("SCROLL UP"):
			...
			text = " ".join(text)
			text = text[1:-1]
			print("Answering question & exiting: " + text)
			#Q: how do i return text then exit the program?
			#A: 
    ...
    #commented out to take input from request
	...
	try:
		while True:
			...
			command = ""
			#create a global variable named callNumber and set it to 0 if it's not already defined
			if 'callNumber' not in globals():
				global callNumber
				callNumber = 0
			#increment the callNumber variable by 1
			callNumber += 1

			shouldIexit = run_cmd(gpt_cmd)
			#if shouldIexit is type String then exit
			if isinstance(shouldIexit, str):
                # print(callnumber)
				return shouldIexit
			if callNumber > 15:
                # print('callnumber is above 10')]
    ...
    #return the value of shouldIexit
    #return shouldIexit
#for teting:
#runFile('is elon musk attractive')